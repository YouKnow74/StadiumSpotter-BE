# Stadium Spotter Back-end
Back-end code for Stadium Spotter application 
...
The Application consists of Mongo, Express, and Node to be the backend server for the React Front End Application.

## Project Name:  Stadium Spotter Back-end
